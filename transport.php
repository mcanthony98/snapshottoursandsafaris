...
<title>Get Transport | Land Cruisers, Tour Vans, Tour Buses - Snapshot Tours and Safaris Kenya, Africa</title>
<meta charset="utf-8">
...
<h1 class="mb-3 bread">Get Transport</h1>
<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Transport <i class="ion-ios-arrow-forward"></i></span></p>
</div>
</div>
</div>
</section>
...
<h2 class="mb-4">Our Transport</h2>
<p>Check out the forms of transport that we offer. All packages are inclusive of a driver.</p>
</div>
</div>
...
<a href="javascript:void()" class="block-20" style="background-image: url('images/cruisers.jpg');">
</a>
<div class="text mt-3 float-right d-block text-center">
<h3 class="heading"><a href="javascript:void()">Land Cruisers</a></h3>
<p>6-seater Luxury vehicle. Suitable for rough terrains and deep wild drives.</p>
</div>
</div>
</div>
...
<p>Suitable for group travel moderate terrains. Upto 6 passangers.</p>
</div>
</div>
</div>
...
<p>Suitable for large groups of people. More than 20 people.</p>
</div>
</div>
</div>
