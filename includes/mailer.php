...
function mailling($recipient, $subject, $body){
  $emfoot = '<p><span style="color:#FFC300;font-size:20px">Snapshot Tours and Safaris - Website Form </span></p>';
  $mail = new PHPMailer(true);                             
      try {
          ...
          $mail->setFrom('info@snapshottoursandsafaris.com', 'Snapshot Tours and Safaris');
          
          //Recipients
          $mail->addAddress($recipient);              
          $mail->addReplyTo('info@snapshottoursandsafaris.com', 'Snapshot Tours and Safaris');
...
function maillinge($recipient, $subject, $body){
  ...
  $signature = '<p><span style="color:#FFC300;font-size:20px">Snapshot Tours and Safaris - Website Form</span></p>';
  ...
  $mailer->send($message);*/
     ...
     try {
         ...
         $mail->setFrom($senderEmail, 'Snapshot Tours and Safaris');
         
         //Recipients
         $mail->addAddress($recipient);              
         $mail->addReplyTo($senderEmail, 'Snapshot Tours and Safaris');
