...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Book a Flight | Snapshot Tours and Safaris</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Book-Flight.css" media="screen">
    ...
    <meta property="og:title" content="Book-Flight">
  ...
  <?php include 'includes/navbar.php'; ?>
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" id="sec-eda2" data-image-width="1280" data-image-height="402">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-title u-text-1">Book a Flight</h1>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="sec-f9d9">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-clearfix u-expanded-width-xs u-layout-wrap u-layout-wrap-1">
          <div class="u-layout">
            <div class="u-layout-row">
              <div class="u-align-left-xs u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <h1 class="u-align-center u-text u-text-1">Planning To Fly?</h1>
                  <p class="u-align-left u-text u-text-2"> Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.&nbsp;Phasellus eget lacinia ipsum. Aliquam lectus tellus, cursus at fermentum id, hendrerit sollicitudin.</p>
                </div>
              </div>
            ...
            <div class="u-align-center u-form u-radius-30 u-white u-form-1">
              <form action="scripts/form-carousel_6509.php" method="POST" class="u-clearfix u-form-spacing-28 u-form-vertical u-inner-form" source="customphp" name="form" style="padding: 4px;">
                ...
                <div class="u-form-group u-label-top u-form-group-4">
                  <label for="text-ad3a" class="u-label">Destination</label>
                  <input type="text" placeholder="Enter your destination" id="text-ad3a" name="destination" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-30 u-white" required="required">
                </div>
                <div class="u-form-date u-form-group u-label-top u-form-group-5">
                  <label for="date-32f7" class="u-label">Date of Travel</label>
