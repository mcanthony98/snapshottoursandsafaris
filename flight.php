...
<h1 class="mb-3 bread">Book a Flight</h1>
<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Flights <i class="ion-ios-arrow-forward"></i></span></p>
</div>
</div>
</div>
</section>
...
<div class="img d-flex align-self-stretch" style="background-image:url(images/flight.jpg);"></div>
</div>
