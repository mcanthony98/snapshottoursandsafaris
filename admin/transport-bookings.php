...
$stqry = "SELECT * FROM transport_bookings";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Transport Bookings </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Admin</a></li>
              <li class="breadcrumb-item active">Transport Bookings </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                                ...
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $strow['vehicle'];?> </td>
                                            <td><?php echo $strow['days'];?></td>
                                            ...
                                            <button class="btn btn-sm btn-primary viewbk" id="<?php echo $strow['booking_id'];?>"  data-toggle="modal" data-target="#modal-view"><i class="fas fa-eye"></i> </button>
                                               ...
                                               <a  href="processes/processes.php?read_tbooking=<?php echo $strow['booking_id'];?>" class="btn btn-sm btn-success"><i class="fas fa-check"></i> </a>
                                               <?php }else{?>
                                                <a  href="processes/processes.php?read_tbooking=<?php echo $strow['booking_id'];?>" class="btn btn-sm btn-warning"><i class="fas fa-times"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
        ...
        <div class="modal-dialog ">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Transport Booking Information</h4>
            ...
            <dl class="row">
                  ...
                  <dd class="col-sm-8" id="tvehicle"></dd>
                  <dt class="col-sm-4">No. of Days</dt>
                  <dd class="col-sm-8" id="tdays"></dd>
 ...
 $(document).ready(function(){  
      $('.viewbk').click(function(){  
          ...
          $.ajax({  
                  ...
                  method:"POST",  
                  data:{fetch_travel_tbooking:id}, 
                  dataType: 'json',
                  success:function(data){
                    $('#tcom').html(data.comment);
                    $('#tdays').html(data.days);
                    $('#tdot').html(data.date_of_travel);
                    $('#tvehicle').html(data.vehicle);
