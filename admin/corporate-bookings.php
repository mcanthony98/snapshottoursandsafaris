...
function coopType ($status){
    if($status == 0){
        return '<span class="text-primary">Not Stated</span>';
    }elseif($status == 1){
        return '<span class="text-primary">Team Building</span>';
    }elseif($status == 2){
        return '<span class="text-primary">Training Program</span>';
    }
}

$stqry = "SELECT * FROM corporate_bookings";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Corporate Training Bookings </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Admin</a></li>
              <li class="breadcrumb-item active">Corporate Bookings </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                                ...
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo coopType($strow['type']);?> </td>
                                            <td><?php echo $strow['people'];?></td>
                                            ...
                                            <button class="btn btn-sm btn-primary viewbk" id="<?php echo $strow['booking_id'];?>"  data-toggle="modal" data-target="#modal-view"><i class="fas fa-eye"></i> </button>
                                               ...
                                               <a  href="processes/processes.php?read_coopbooking=<?php echo $strow['booking_id'];?>" class="btn btn-sm btn-success"><i class="fas fa-check"></i> </a>
                                               <?php }else{?>
                                                <a  href="processes/processes.php?read_coopbooking=<?php echo $strow['booking_id'];?>" class="btn btn-sm btn-warning"><i class="fas fa-times"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
