...
$stqry = "SELECT * FROM flight_bookings";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Flight Bookings </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                                ...
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $strow['flight_from'];?> - <?php echo $strow['flight_to'];?> <br> <?php echo $strow['date_of_travel'];?></td>
                                            ...
                                            <button class="btn btn-sm btn-primary viewbk" id="<?php echo $strow['booking_id'];?>"  data-toggle="modal" data-target="#modal-view"><i class="fas fa-eye"></i> </button>
                                               ...
                                               <a  href="processes/processes.php?read_fbooking=<?php echo $strow['booking_id'];?>" class="btn btn-sm btn-success"><i class="fas fa-check"></i> </a>
                                               <?php }else{?>
                                                <a  href="processes/processes.php?read_fbooking=<?php echo $strow['booking_id'];?>" class="btn btn-sm btn-warning"><i class="fas fa-times"></i> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
        ...
        <div class="modal-dialog ">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Flight Booking Information</h4>
            ...
            <dl class="row">
                  ...
                  <dd class="col-sm-8" id="tfrom"></dd>
                  <dt class="col-sm-4">To</dt>
                  <dd class="col-sm-8" id="tto"></dd>
